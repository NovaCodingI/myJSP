...
<%
	...
	표현언어로 접근하여 쉽게 출력 할 수 있습니다.
	
	- JSP 내장객체의 영역에 담긴 속성을 사용합니다.
	- 산술연산, 논리연산, 비교연산이 가능 합니다.
	- 자바 클래스에 정의된 메소드를 호출 할 수 있습니다.
...
%>
	...
	<ul>
		<p>가장가까운 페이지 영역이 출력되는걸 볼수있습니다.</p>
		<li>${scopeValue }</li>
	</ul>
	
	<!-- 기존에 작성되었던 내용은 출력되지 않음, forward는 페이지 전환하기 때문이다
		페이지영역을 제외한 나머지 영역은 저장되어있던 값들은 보존됩니다 
		가까운 영역부터 찾아서 출력해줍니다.
	-->
