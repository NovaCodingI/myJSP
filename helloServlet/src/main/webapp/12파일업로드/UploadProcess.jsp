...
<body>
<%
	// 저장할 디렉토리의 실제 경로, 주소표시줄을 그대로 가져와서 사용하면 \ 입니다 /로 바꿔주세요
	String saveDirectory = "C:/upload";
	
	// webapp 폴더 하위에 디렉토리를 생성 TEST용
	// saveDirectory = "C:\\Users\\user\\git\\myJSP\\helloServlet\\src\\main\\webapp\\upload";
	
	// 파일의 최대 크기(1MB)
	int maxPostSize = 1024 * 1000;
	// 용량이 크면 java.io.IOException: Posted content length of 1202671 exceeds limit of 1024000 오류 납니다.
	...
	// 3. 파일명 변경
		...
		// DTO생성, set메소드를 이용할수도 있지만 매개변수로 바로 이용
		...
		if(res>0){
			...
			// 이전 페이지로 이동
			JSFunction.alertBack("등록에 실패 하였습니다."
									+ "관리자에게 문의해주세요.", out);
		}
