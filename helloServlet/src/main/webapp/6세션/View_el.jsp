...
<%
	...
	*/
	...
	// 영역에 저장하는 jsp가 출력해준다. 역활이 분담되므로써 유지보수가 수월해지고
	// 컨트롤러가 하는일은 어떤페이지를 열어줄건지 어떤객체를 저장해줄건지
...
<h2>상세 보기</h2>
	...
	<table border="1" width="90%">
        ...
        <tr>
            <td>내용</td>
            <!-- el에서 replace에서 사용되려면 서버에서 처리가 되려면 BoardDao에서 처리가 되어야한다. -->
