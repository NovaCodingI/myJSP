...
<%
	...
	자바빈으로 생성될 수 있는 객체(DTO/VO)
		...
		- 기본 생성자가 존재해야 한다.
		- 멤버변수의 접근제어자는 private로 선언 되어야 한다.
		- 멤버변수에 접근 가능한 getter 와 setter 메소드가 존재해야 한다.
		- getter 와 setter는 접근자가 public으로 선언 되어야 한다.
...
%>
	...
	<!-- 
		...
		dto 패키지의 Person 객체를 생성 후 request영역에 저장
